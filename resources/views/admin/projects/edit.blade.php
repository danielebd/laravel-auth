        ...
        <form action="{{ route('admin.projects.update', $project) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" class="form-control" id="created_by" name="created_by" value="{{$project->created_by}}">
                </div>
            </div>
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="completed" name="completed" value="{{$project->completed}}">
